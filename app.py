...
Choir1 = input("I enjoy listening to music and singing to the tune.")
...
Drama3 = input("I am comfortable with handling with props, music, lights etc backstage.")
Art3 = input("I like to express myself through art.")
Choir3 = input("I am confident to sing in front of crowds.")

Com4 = input("I feel happy and relaxed when computing.")
Bball4 = input("I enjoy jumping around and keeping my body occupied.")
Orchestra4 = input("I enjoy the sound of different music instruments blending together to create a beautiful melody.")
...
Art5 = input("I enjoy using my imagination to express myself.")
Choir5 = input ("I enjoy singing and listening to others sing with me.")
